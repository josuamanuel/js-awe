(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash'), require('ramda'), require('fluture'), require('util/types'), require('node-fetch'), require('loglevel'), require('stream'), require('stream-transform'), require('util'), require('fs')) :
  typeof define === 'function' && define.amd ? define(['exports', 'lodash', 'ramda', 'fluture', 'util/types', 'node-fetch', 'loglevel', 'stream', 'stream-transform', 'util', 'fs'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.awe = {}, global._, global.R, global.F, global.types, global.fetch, global.loglevel, global.stream, global.streamTransform, global.util, global.fs));
})(this, (function (exports, _, R, F, types, fetch, loglevel, stream, streamTransform, util, fs) { 'use strict';
