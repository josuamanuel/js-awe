...
console.log(
  await raceCond(sleepWithValue(6/* ms */, 5 /* value */), sleepWithValue(4 /* ms */, 3 /* value */))
)
...
const [customerPrefs, customerDefaultPrefs] = await Promise.all([getCustomerPrefs('F12'), getCustomerDefaultPrefs() ])
